...
const menuGroups = ref([
    {
        ...
        menuItems: [
            ...
            },
            {
                ...
                route: "#",
                children: [
                    { label: "Engine", route: route("marketplace.index") },
                    { label: "Brand", route: route("brand.index") },
                    { label: "Category", route: route("comodity.index") },
                    { label: "Keyword", route: route("keyword.index") },
                    { label: "Search List", route: route("search-list.index") },
                    {
                        label: "Supervision List",
                        route: route("supervision-list.index"),
                    },
                ],
            },
            {
...
<template>
    <aside
        class="absolute left-0 top-0 z-50 flex h-screen w-60 flex-col overflow-y-hidden bg-white dark:bg-gray-800 duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0"
        :class="{
